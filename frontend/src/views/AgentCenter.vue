...
.agent-orb { position: relative; display: grid; width: 84px; flex: 0 0 84px; aspect-ratio: 1; place-items: center; border: 1px solid var(--border-hairline); border-radius: 16px; background: var(--surface-elevated); }
...
.runtime-metric { display: grid; min-height: 92px; align-content: center; gap: 8px; padding: 16px; border: 1px solid var(--border-hairline); border-radius: 12px; background: var(--surface-elevated); }.runtime-metric span { color: var(--el-text-color-secondary); font-size: 12px; }.runtime-metric strong { font-size: 22px; letter-spacing: -0.03em; white-space: nowrap; }.runtime-metric:first-child strong { font-size: 18px; }
...
.research-metrics { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 12px; }.research-metrics > div { display: grid; gap: 7px; padding: 16px 18px; border: 1px solid var(--border-hairline); border-radius: 12px; background: var(--surface-elevated); }.research-metrics span { color: var(--el-text-color-secondary); font-size: 12px; }.research-metrics strong { font-size: 24px; letter-spacing: -0.04em; }
...
.pipeline-card { --pipeline-accent: var(--apple-blue); overflow: hidden; padding: 20px; border: 1px solid var(--border-hairline); border-radius: 12px; background: var(--surface-elevated); }.pipeline-card--green { --pipeline-accent: var(--el-color-success); }.pipeline-card--orange { --pipeline-accent: var(--el-color-warning); }
